...
namespace Mercadosfera.Data
{
    ...
    [Serializable]
[DataContract] public partial class CERTIFICADOS
    {
        public CERTIFICADOS()
        {
        ...
        [DataMember] public Nullable<int> IdTipoCertificado { get; set; }
        ...
        [DataMember] public virtual TIPOCERTIFICADO TIPOCERTIFICADO { get; set; }
