...
namespace Mercadosfera.Data
{
    ...
    [Serializable]
[DataContract] public partial class TIENDAS_TEXTOS
    {
        [DataMember] public int ID { get; set; }
        [DataMember] public Nullable<int> IdVendedor { get; set; }
        [DataMember] public Nullable<int> IdTipoTexto { get; set; }
        ...
        [DataMember] public virtual DES_TIPOTEXTO DES_TIPOTEXTO { get; set; }
        [DataMember] public virtual TIENDAS TIENDAS { get; set; }
    }
}
