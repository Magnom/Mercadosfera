...
namespace Mercadosfera.Data
{
    ...
    [Serializable]
[DataContract] public partial class PAISES
    {
        public PAISES()
        {
        ...
        [DataMember] public string Decripcion { get; set; }
        ...
        [DataMember] public virtual ICollection<COMUNIDADES> COMUNIDADES { get; set; }
    }
}
