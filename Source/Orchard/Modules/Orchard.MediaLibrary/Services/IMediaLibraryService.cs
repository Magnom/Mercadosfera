...
namespace Orchard.MediaLibrary.Services {
    public interface IMediaLibraryService : IDependency {
        ...
        IEnumerable<MediaPart> GetMediaContentItems(int skip, int count, string order, string mediaType, IUser usr);
        ...
        /// <summary>
        /// Mes customized, returns the root folder based on the user
        /// </summary>
        ...
        string GetMediaRoot(string folderPath, IUser usr);
